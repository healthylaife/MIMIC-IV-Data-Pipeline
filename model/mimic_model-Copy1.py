...
class LSTMAttn(nn.Module):
    def __init__(self,device,cond_vocab_size,cond_seq_len,proc_vocab_size,proc_seq_len,med_vocab_size,med_seq_len,out_vocab_size,out_seq_len,chart_vocab_size,chart_seq_len,lab_vocab_size,lab_seq_len,embed_size,rnn_size,batch_size): #proc_vocab_size,med_vocab_size,lab_vocab_size
...
class CNNBase(nn.Module):
    ...
    def build(self):
        ...
        if out_vocab_size:
            self.out=CodeCNN(self.device,self.embed_size,self.rnn_size,self.out_vocab_size,self.out_seq_len,self.batch_size)
        if chart_vocab_size:
            self.chart=CodeCNN(self.device,self.embed_size,self.rnn_size,self.chart_vocab_size,self.chart_seq_len,self.batch_size)
        if lab_vocab_size:
            self.lab=CodeCNN(self.device,self.embed_size,self.rnn_size,self.lab_vocab_size,self.lab_seq_len,self.batch_size)
