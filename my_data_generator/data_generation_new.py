...
class Generator:
    def __init__(
        ...
        self.impute = impute
        self.feat_cond, self.feat_proc, self.feat_med, self.feat_lab = (
            feat_cond,
            feat_proc,
            feat_med,
            feat_lab,
    ...
    def generate_cond(self):
        cond = pd.read_csv(
            "./data/features/preproc_diag.csv.gz",
            compression="gzip",
            header=0,
            index_col=None,
        )
    ...
    def generate_proc(self):
        proc = pd.read_csv(
            "./data/features/preproc_proc.csv.gz",
            compression="gzip",
            header=0,
            index_col=None,
        )
        ...
        for hid in tqdm(self.hids):
            ...
            if self.feat_lab:
                ...
                if df2.shape[0] == 0:
                    ...
                    # print(df2.head())
                    dataDic[hid]["Lab"]["signal"] = df2.iloc[:, 0:].to_dict(
                        orient="list"
                    )
